...
/******/ 	__webpack_require__.p = "/Users/bencooling/projects/bitbucket/redux-examples/react-todo";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deepFreeze = __webpack_require__(168);

	var _deepFreeze2 = _interopRequireDefault(_deepFreeze);

	var _expect = __webpack_require__(169);
	...
	var refine = function refine() {
	  ...
	  return action.type === 'REFINE_TODOS' ? action.refine : state;
	};
	...
	var todos = function todos() {
	  ...
	  switch (action.type) {
	    case 'ADD_TODO':
	      return [].concat(_toConsumableArray(state), [{ id: state.length + 1, text: action.text, completed: false }]);
	      break;
	...
	var reducer = (0, _redux.combineReducers)({
	  refine: refine, // es6 shorthand equivalent to refine: refine
	  todos: todos
	});
	...
	var TodoApp = function TodoApp(_ref2) {
	  ...
	  var items = store.getState().todos.map(function (todo) {
	    return _react2.default.createElement(Items, { key: todo.id, text: todo.text });
	  });
	...
	var render = function render() {
	  _reactDom2.default.render(_react2.default.createElement(TodoApp, { onClick: function onClick() {
	      return store.dispatch({ type: 'ADD_TODO', text: 'Breathe' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expectation = __webpack_require__(170);

	var _Expectation2 = _interopRequireDefault(_Expectation);

	var _SpyUtils = __webpack_require__(177);

	var _assert = __webpack_require__(175);

	var _assert2 = _interopRequireDefault(_assert);

	var _extend = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isRegexp = __webpack_require__(174);
	...
	var _TestUtils = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(176);
